...
<div id="container_form" class="col-2 my-0 mx-auto d-flex justify-content-center">

<form method="POST" action="../../app/Controller/UserController.php" class="text-center">
  <div class="mb-3 col-12">
    <label for="name" class="form-label">Nome completo</label>
    <input type="text" class="form-control" id="name" name="name" placeholder="Digite o seu nome completo">
  </div>
  <div class="mb-3 col-12">
    <label for="email" class="form-label">Email</label>
    <input type="email" class="form-control" id="email" name="email" placeholder="Digite o seu endereço de email">
  </div>
  <div class="mb-3 col-12">
  ...
  <div class="mb-3 col-12">
    ...
    <input type="text" class="form-control" id="phone" name="phone" placeholder="Digite o seu numero de telefone">
  </div>
